...
console.log(alfabeto.includes(letra_digitada.key.toUpperCase()))
    ...
    for (let count = ini_count; count < fin_count; count++) {
        ...
        if (quadrados[count].innerHTML == '') {
                ...
                if (letra_digitada.key && alfabeto.includes(letra_digitada.key.toUpperCase())){
            ...
            if (palavra_usuario.length == 5) { //quando o usuario termina de digitar a palavra com 5 letras entra nesse ifmar
